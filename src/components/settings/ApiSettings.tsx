...
const MODEL_OPTIONS = [
  { id: 'eleven_v3', name: 'Eleven v3 — Mais expressivo, 70+ idiomas' },
  { id: 'eleven_flash_v2_5', name: 'Flash v2.5 — Baixa latência, 32 idiomas (Recomendado)' },
  { id: 'eleven_multilingual_v2', name: 'Multilingual v2 — Alta fidelidade, 29 idiomas' },
  { id: 'eleven_flash_v2', name: 'Flash v2 — Ultra rápido, inglês' },
  { id: 'eleven_turbo_v2_5', name: 'Turbo v2.5 (Legacy)' },
  { id: 'eleven_turbo_v2', name: 'Turbo v2 (Legacy)' },
];
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <VoiceSelector
              ...
              onChange={(voiceId) => setSettings({ ...settings, elevenlabs_voice_id: voiceId })}
            />
          </div>
