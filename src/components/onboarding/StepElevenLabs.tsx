...
const MODELS = [
  { id: 'eleven_v3', name: 'Eleven v3', description: 'Mais expressivo, 70+ idiomas, tags de emoção' },
  { id: 'eleven_flash_v2_5', name: 'Flash v2.5', description: 'Baixa latência, alta qualidade, 32 idiomas' },
  { id: 'eleven_multilingual_v2', name: 'Multilingual v2', description: 'Alta fidelidade, 29 idiomas' },
  { id: 'eleven_flash_v2', name: 'Flash v2', description: 'Ultra rápido, apenas inglês' },
  { id: 'eleven_turbo_v2_5', name: 'Turbo v2.5 (Legacy)', description: 'Rápido, 32 idiomas' },
  { id: 'eleven_turbo_v2', name: 'Turbo v2 (Legacy)', description: 'Rápido, apenas inglês' },
];
